...
# Specific version
docker pull ghcr.io/iamvirul/deepdiff-db:v1.5.0
```
...
| `v1.5.0-amd64` | Architecture-specific manifest |
| `v1.5.0-arm64` | Architecture-specific manifest |
